...
load_from_file = not True # im lazy
load_trip_ids = not True
...
if not load_from_file:
    ...
    for op in operators:
        ...
        time.sleep(1.5)
    print("Done\nSaving to file...")
    with open('train_bus/lines.json', 'w') as f:
    ...
    for op in operators:
        for line in lines[op]:
            if line['TransportMode'] in ['metro', 'rail', 'cableway'] or (op == 'SF' and "RAPID" in line['Name']):
    ...
    print("Done\nSaving to file...")
    with open('train_bus/rail_lines.json', 'w') as f:
    ...
    print("Done\nSaving to file...")
    with open('train_bus/stations.json', 'w') as f:
    ...
    with open('train_bus/lines.json', 'r') as f:
        lines = json.load(f)
...
if not load_trip_ids:
    ...
    print("Done\nSaving to file...")
    with open('train_bus/trip_ids.json', 'w') as f:
        f.write(json.dumps(trip_ids, indent=4))
    print("Done")

    with open('train_bus/route_trip_ids.json', 'w') as f:
        f.write(json.dumps(route_trip_ids, indent=4))
    print("Done")
else:
    print("Loading from file...")
    with open('train_bus/trip_ids.json', 'r') as f:
...
print("Done\nSaving to file...")
with open('train_bus/shapes.json', 'w') as f:
