import ipyleaflet, requests, json, folium, threading, time
from utils import makeBeautifyIcon
import math
from folium.plugins import LocateControl, Realtime, GroupedLayerControl
...
# Draw lines from ace.geojson
with open('shapes/CE.geojson', 'r') as f:
...
for op in operators:
    ...
    if op == 'CE':
        print("Skipping ACE, drawn later")
        continue
